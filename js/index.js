var waterfallCanvas = function (c, cw, ch, hue)
{
	...
	this.Particle = function ()
	{
		...
		this.hue = _this.rand(_this.hue - 10, _this.hue + 10);
	...
	this.Particle.prototype.renderBubble = function ()
	{
		...
		_this.ctx.beginPath();
		_this.ctx.arc(this.x + this.width / 2, _this.ch - 20 - _this.rand(0, 10), _this.rand(1, 8), 0, Math.PI *
		                                                                                               2, false);
		_this.ctx.fill();
	};
...
if (isCanvasSupported())
{
	...
	var cw = c1.width = c2.width = 100;
	c1.height = c2.height = width;
	var ch = width + delta;
	var waterfall_1 = new waterfallCanvas(c1, cw, ch, 60);
	var waterfall_2 = new waterfallCanvas(c2, cw, ch, 210);
	setupRAF();
	waterfall_1.init();
	waterfall_2.init();
}